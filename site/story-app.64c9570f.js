    ...
    <article class="intel-report">
      <header class="intel-header">
        <div class="intel-meta">
          ...
          <time class="intel-date" datetime="${story.generated_at || story.timestamp || story.date || ''}" title="${date}">${formatTimeAgo(story.generated_at || story.timestamp || story.date)}</time>
