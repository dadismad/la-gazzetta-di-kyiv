...
(function() {
    ...
    <article class="intel-report">
      <header class="intel-header">
        <div class="intel-meta">
          ...
          <time class="intel-date" datetime="${story.generated_at || story.timestamp || story.date || dataGenAt}">${date}</time>
  ...
  async function init() {
    ...
    const stories = data.stories || [];
    const dataGenAt = data.generated_at || '';  // v22.38 fallback for stories without own timestamp
