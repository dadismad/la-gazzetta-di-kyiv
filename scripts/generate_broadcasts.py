...
def generate_telegram_post(story, tier, cf):
    """Generate Telegram-ready post with emoji and bold."""
    ...
    post = f"""{emoji} **{tier}** | {headline}

{summary}

💰 **Capital Flow:** ${amount}B {direction} {asset} · {pace}× velocity · {confidence}% confidence

🎯 **THE PLAY:** {play[:100]}

🔗 Full intel: {url}

#GazzettaDiKyiv #CapitalFlows #Contrarian"""
